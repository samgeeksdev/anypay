...
return [
    ...
    */
    ...
    | Samgeeksdev\Multipay\Abstracts\Driver in your driver.
    |
    */
    'map' => [
        'local' => \Samgeeksdev\Multipay\Drivers\Local\Local::class,
        'gooyapay' => \Samgeeksdev\Multipay\Drivers\Gooyapay\Gooyapay::class,
        'fanavacard' => \Samgeeksdev\Multipay\Drivers\Fanavacard\Fanavacard::class,
        'asanpardakht' => \Samgeeksdev\Multipay\Drivers\Asanpardakht\Asanpardakht::class,
        'atipay' => \Samgeeksdev\Multipay\Drivers\Atipay\Atipay::class,
        'behpardakht' => \Samgeeksdev\Multipay\Drivers\Behpardakht\Behpardakht::class,
        'digipay' => \Samgeeksdev\Multipay\Drivers\Digipay\Digipay::class,
        'etebarino' => \Samgeeksdev\Multipay\Drivers\Etebarino\Etebarino::class,
        'idpay' => \Samgeeksdev\Multipay\Drivers\Idpay\Idpay::class,
        'irankish' => \Samgeeksdev\Multipay\Drivers\Irankish\Irankish::class,
        'jibit' => \Samgeeksdev\Multipay\Drivers\Jibit\Jibit::class,
        'nextpay' => \Samgeeksdev\Multipay\Drivers\Nextpay\Nextpay::class,
        'omidpay' => \Samgeeksdev\Multipay\Drivers\Omidpay\Omidpay::class,
        'parsian' => \Samgeeksdev\Multipay\Drivers\Parsian\Parsian::class,
        'pasargad' => \Samgeeksdev\Multipay\Drivers\Pasargad\Pasargad::class,
        'payir' => \Samgeeksdev\Multipay\Drivers\Payir\Payir::class,
        'paypal' => \Samgeeksdev\Multipay\Drivers\Paypal\Paypal::class,
        'payping' => \Samgeeksdev\Multipay\Drivers\Payping\Payping::class,
        'paystar' => \Samgeeksdev\Multipay\Drivers\Paystar\Paystar::class,
        'poolam' => \Samgeeksdev\Multipay\Drivers\Poolam\Poolam::class,
        'sadad' => \Samgeeksdev\Multipay\Drivers\Sadad\Sadad::class,
        'saman' => \Samgeeksdev\Multipay\Drivers\Saman\Saman::class,
        'sep' => \Samgeeksdev\Multipay\Drivers\SEP\SEP::class,
        'sepehr' => \Samgeeksdev\Multipay\Drivers\Sepehr\Sepehr::class,
        'walleta' => \Samgeeksdev\Multipay\Drivers\Walleta\Walleta::class,
        'yekpay' => \Samgeeksdev\Multipay\Drivers\Yekpay\Yekpay::class,
        'zarinpal' => \Samgeeksdev\Multipay\Drivers\Zarinpal\Zarinpal::class,
        'zibal' => \Samgeeksdev\Multipay\Drivers\Zibal\Zibal::class,
        'sepordeh' => \Samgeeksdev\Multipay\Drivers\Sepordeh\Sepordeh::class,
        'rayanpay' => \Samgeeksdev\Multipay\Drivers\Rayanpay\Rayanpay::class,
        'sizpay' => \Samgeeksdev\Multipay\Drivers\Sizpay\Sizpay::class,
        'vandar' => \Samgeeksdev\Multipay\Drivers\Vandar\Vandar::class,
        'aqayepardakht' => \Samgeeksdev\Multipay\Drivers\Aqayepardakht\Aqayepardakht::class,
        'azki' => \Samgeeksdev\Multipay\Drivers\Azki\Azki::class,
        'payfa' => \Samgeeksdev\Multipay\Drivers\Payfa\Payfa::class,
        'toman' => \Samgeeksdev\Multipay\Drivers\Toman\Toman::class,
        'bitpay' => \Samgeeksdev\Multipay\Drivers\Bitpay\Bitpay::class,
        'minipay' => \Samgeeksdev\Multipay\Drivers\Minipay\Minipay::class,
    ]
];
